...
class Persons(): 
    ...
    def insertDescription(self, row_index: int, description: str) -> None:
        cursor = self.conn.cursor()
        cursor.execute(f"INSERT OR REPLACE INTO persons (id, description) VALUES ({row_index}, {description})")
